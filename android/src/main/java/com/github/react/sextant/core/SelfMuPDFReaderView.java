package com.github.react.sextant.core;
...
public class SelfMuPDFReaderView extends ReaderView {
...
//		SharedPreferencesUtil.put(SPConsts.SP_COLOR_SEARCH_TEXT, color);
	...
	private void setup() {
		...
		setBackgroundColor(ContextCompat.getColor(mContext, com.lonelypluto.pdflibrary.R.color.muPDFReaderView_bg));
	}

	public SelfMuPDFReaderView(Context context) {
		super(context);
		mContext = context;
		setup();
	}

	public SelfMuPDFReaderView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		mContext = context;
		setup();
